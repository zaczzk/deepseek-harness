...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  EnhancePreviewRequest: 'preview request wire type is owned by packages/interaction/enhance-runtime/src/types.ts',
  EnhancePreviewResult: 'preview result wire type is owned by packages/interaction/enhance-runtime/src/types.ts',
  EnhancePreviewChunk: 'streaming preview chunk wire type is owned by packages/interaction/enhance-runtime/src/types.ts',
